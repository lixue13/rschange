...
def get_args():
    ...
    parser.add_argument("-c", "--config", type=str, default="configs/MambNet.py")
    parser.add_argument("--ckpt", type=str, default="work_dirs/CLCD_BS4_epoch200/MambNet/CLCD/version_2/ckpts/test/test_change_f1/test_change_f1=0.7515-epoch=56.ckpt")
    parser.add_argument("--output_dir", type=str, default="output/clcd/MambNet")
