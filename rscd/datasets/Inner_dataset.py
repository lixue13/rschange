...
import numpy as np
class InnerCD(BaseDataset):
    def __init__(self, data_root='data/Inner_data', mode='train', transform=None, imgA_dir='A', imgB_dir='B', mask_dir='label', img_suffix='.png', mask_suffix='.png', **kwargs):
        super(InnerCD, self).__init__(transform, mode)
